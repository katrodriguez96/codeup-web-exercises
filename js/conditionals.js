...
function analyzeColor(color) {
    if (color === "red") {
        ...
        return "Orange rhymes with door hinge";
...
//         break;
//     case "orange":
//         console.log("Orange rhymes with door hinge");
//         break;
//     case "yellow":
...
let totalAmount = prompt("Enter your bill's total:", "");
